...
namespace RFBCodeWorks.WPF.Behaviors
{
    ...
    public static partial class ControlDefinitions
    {
        ...
        /// <summary>
        /// Bind to Visibility, IsEnabled, and ToolTip to an <see cref="IControlDefinition"/>
        /// </summary>
        public static void BindIControlDefinition(Control obj, IControlDefinition controlVM)
        {
            if (controlVM is null) return;
            SetBinding(obj, UIElement.VisibilityProperty, nameof(IControlDefinition.Visibility), controlVM, BindingMode.OneWay);
            SetBinding(obj, FrameworkElement.ToolTipProperty, nameof(IControlDefinition.ToolTip), controlVM, BindingMode.OneWay);
            SetBinding(obj, FrameworkElement.IsEnabledProperty, nameof(IControlDefinition.IsEnabled), controlVM, BindingMode.OneWay);
        }
        ...
        /// </remarks>
        public static void UnbindIControlDefinition(Control obj, IControlDefinition controlVM)
        {
            UnbindIfBound(obj, UIElement.VisibilityProperty, controlVM);
            UnbindIfBound(obj, FrameworkElement.ToolTipProperty, controlVM);
            UnbindIfBound(obj, FrameworkElement.IsEnabledProperty, controlVM);
        }
    }
}
