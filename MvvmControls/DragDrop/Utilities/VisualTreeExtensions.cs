...
{
    /// <remarks>
    /// Copied ripped from https://github.com/punker76/gong-wpf-dragdrop - DropTargetAdorner , which allows commercial use and modification    
    /// </remarks>
...

    {
        ...
        public static UIElement TryGetNextAncestorDropTargetElement(this UIElement element)
        {
            ...
            while (ancestor != null)
            {
                if (ancestor.AllowDrop) // Modified from IsDropTarget()
                {
                    return ancestor;
                }
