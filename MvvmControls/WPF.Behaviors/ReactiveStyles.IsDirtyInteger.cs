...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    ...
    /// </summary>
    public static class ReactiveStyleIsDirtyInteger
    {
        ...
        public static readonly DependencyProperty EnableComparerProperty =
            DependencyProperty.RegisterAttached("EnableComparer", typeof(bool), typeof(ReactiveStyleIsDirtyInteger), new PropertyMetadata(true, IsEnabledChanged));
        ...
        public static readonly DependencyProperty OriginalValueProperty =
            DependencyProperty.RegisterAttached("OriginalValue", typeof(int), typeof(ReactiveStyleIsDirtyInteger), new PropertyMetadata(0, CompareValues));
        ...
        public static readonly DependencyProperty CurrentValueProperty =
            DependencyProperty.RegisterAttached("CurrentValue", typeof(int), typeof(ReactiveStyleIsDirtyInteger), new PropertyMetadata(0, CompareValues));
