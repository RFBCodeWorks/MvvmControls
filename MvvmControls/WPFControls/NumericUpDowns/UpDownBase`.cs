...
namespace RFBCodeWorks.WPFControls.Primitives
{
        ...
        where T : struct, IComparable<T>, IEquatable<T>, IFormattable
    {
        ...
        protected static void OverrideMetaData(Type type, T smallChange, T largeChange, T minValue, T maxValue)
        {
            ...
            MinimumProperty.OverrideMetadata(type, new PropertyMetadata(minValue, DoNothingCallBack, CoerceMinimum));
            MaximumProperty.OverrideMetadata(type, new PropertyMetadata(maxValue, DoNothingCallBack, CoerceMaximum));
            ValueProperty.OverrideMetadata(type, new PropertyMetadata(default(T), DoNothingCallBack, CoerceValue));
        ...
        {
            return !IsReadOnly && IsLessThan(Maximum, Value);
        }
        ...
        {
            return !IsReadOnly && IsGreaterThan(Minimum, Value);
        }
