...
namespace RFBCodeWorks.WPFControls
{
    ...
    /// </summary>
    /// <remarks>
    /// <see href="https://github.com/dotnet/docs-desktop/blob/main/dotnet-desktop-guide/samples/snippets/csharp/VS_Snippets_Wpf/OutlineTextControlViewer/CSharp/OutlineTextControl.cs"/>
    /// </remarks>
    public class OutlineTextControl : FrameworkElement
    {
        ...
        public void CreateText()
        {
            ...
            //Get the origin based on location of control


            // Build the geometry object that represents the text.
            _textGeometry = formattedText.BuildGeometry(new System.Windows.Point(0, 0));
            var width = _textGeometry.Bounds.Width;
            var height = _textGeometry.Bounds.Height;

            // Build the geometry object that represents the text highlight.
            if (Highlight == true)
            {
                _textHighLightGeometry = formattedText.BuildHighlightGeometry(new System.Windows.Point(0, 0));
                width = _textHighLightGeometry.Bounds.Width;
                height = _textHighLightGeometry.Bounds.Height;
            }

            // Center the text onto the control and size accordingly
            var newOrigin = new System.Windows.Point(0, 0); //new Point(-(width / 2), -(height / 2));
            Height = height > 0 ? height : 0;
            Width = width > 0 ? width : 0;
            //_textGeometry = formattedText.BuildGeometry(newOrigin);
            //if (Highlight == true) _textHighLightGeometry = formattedText.BuildHighlightGeometry(newOrigin);
        }
        //</SnippetCreateText>
        #endregion
