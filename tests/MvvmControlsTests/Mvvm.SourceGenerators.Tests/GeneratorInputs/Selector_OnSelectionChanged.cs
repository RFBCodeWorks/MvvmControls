...
{
    public partial class Selector_OnSelectionChanged
    {
        ...
        public Selector_OnSelectionChanged()
        {
        ...
        public static string GetPartialText(string generatorName)
        {
            string methodName = true switch
            {
                ...
                true when generatorName.Contains("ListBox") => "OnItemsListBoxSelectionChanged",
...
namespace RFBCodeWorks.Mvvm.SourceGenerators.Tests.GeneratorInputs
{{
    partial class Selector_OnSelectionChanged
    {{
        ...
        [ComboBox]
        [Selector]
        [OnSelectionChanged(nameof(CommandToNotify), Action = nameof(Action), SelectorAction = nameof(SelectorAction))]
