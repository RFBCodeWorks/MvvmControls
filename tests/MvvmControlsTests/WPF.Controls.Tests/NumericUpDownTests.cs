...
namespace RFBCodeWorks.WPF.Controls.Tests
{
    ...
    public class NumericUpDownTests
    {
        ...
        /// </summary>
        private void ModelTest_Issue4<T, I>(T cntrl, I zero, I incrementValue)
            where I : struct, IComparable<I>, IEquatable<I>, IFormattable
        ...
        public void DecimalUpDown()
        {
            ...
            ModelTest_Issue4(cntrl, (double)0, 5);
            ModelTest_UpDown(cntrl, (double)0, -100, 100, 25, -500, 500);
        }
    }
}